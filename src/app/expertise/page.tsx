            ...
            <div className='flex xs:flex-row flex-col w-full h-auto'>
                <div className='xs:w-1/2 w-full h-auto xs:border-r border-secondary'>
                    <div className='w-full border-b sm:h-[230px] xs:h-[200px] h-auto flex flex-col gap-3 border-secondary py-10 px-1'>
                        <h3 className='gradient-title font-semibold max-md:leading-6 xl:text-[40px] lg:text-4xl md:text-3xl sm:text-2xl xs:text-xl text-lg'>Workflow Automation</h3>
                    ...
                    <div className='w-full border-b sm:h-[230px] xs:h-[200px] h-auto flex flex-col gap-3 border-secondary py-10 px-1'>
                        <h3 className='gradient-title font-semibold max-md:leading-6 xl:text-[40px] lg:text-4xl md:text-3xl sm:text-2xl xs:text-xl text-lg'>CRM & Sales Automation</h3>
                    ...
                    <div className='w-full sm:h-[230px] xs:h-[200px] h-auto  max-xs:border-b border-secondary flex flex-col gap-3 py-10 px-1'>
                        <h3 className='gradient-title font-semibold max-md:leading-6 xl:text-[40px] lg:text-4xl md:text-3xl sm:text-2xl xs:text-xl text-lg'>Marketing Automation</h3>
                ...
                <div className='xs:w-1/2 w-full h-auto'>
                    <div className='w-full border-b sm:h-[230px] xs:h-[200px] h-auto flex flex-col gap-3 border-secondary sm:pl-8 pl-4 py-10 px-1'>
                        <h3 className='gradient-title font-semibold max-md:leading-6 xl:text-[40px] lg:text-4xl md:text-3xl sm:text-2xl xs:text-xl text-lg'>Finance Automation</h3>
                    ...
                    <div className='w-full border-b sm:h-[230px] xs:h-[200px] h-auto flex flex-col gap-3 border-secondary sm:pl-8 pl-4 py-10 px-1'>
                        <h3 className='gradient-title font-semibold max-md:leading-6 xl:text-[40px] lg:text-4xl md:text-3xl sm:text-2xl xs:text-xl text-lg'>HR & Employee Onboarding</h3>
                    ...
                    <div className='w-full sm:h-[230px] xs:h-[200px] h-auto flex flex-col gap-3 sm:pl-8 pl-4 py-10 px-1'>
                        <h3 className='gradient-title font-semibold max-md:leading-6 xl:text-[40px] lg:text-4xl md:text-3xl sm:text-2xl xs:text-xl text-lg'>Custom Integration</h3>
